...
public enum PISDProperties {
    ...
    //Inicio Insurance_Type
    FIELD_INSURANCE_TYPE_ID("INSURANCE_TYPE_ID"),
    FIELD_INSURANCE_TYPE_NAME("INSURANCE_TYPE_NAME"),
    FIELD_REGISTRY_SITUATION_TYPE("REGISTRY_SITUATION_TYPE"),
    QUERY_INSERT_INSURANCE_TYPE("PISD.INSERT_INSURANCE_TYPE"),
